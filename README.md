...
<img width="1000" alt="Image" src="https://github.com/user-attachments/assets/cd3fe01f-6a63-4443-b664-6ffab89ac49f" />
  ...
  1. 핵심 판매자 독려
플랫폼 내에서 가장 큰 매출을 발생시키는 판매자들에게 인센티브를 제공하여 장기적인 협력 관계를 강화하고자 함

  2. 신규 판매자 유입 촉진 
초기 진입 장벽을 낮춰 더 많은 신규 판매자들이 플랫폼에 유입될 수 있도록 유인책을 마련

  3. 판매자 이탈률 감소 
기존 판매자들의 이탈을 방지하고, 보다 안정적인 판매 환경을 조성하여 지속적인 매출 성장을 목표로 함
...
개선된 수수료 정책을 통해 판매자와 플랫폼이 함께 성장하는 선순환 구조를 구축
